	...
	<div id="review_modal">
		...
		<form action="ReviewService.do" method="POST">
			<div class="star_rating">
				<fieldset class="rate">
					<input type="radio" id="rating10" name="rating" value="10"><label
						...
						value="7"><label class="half" for="rating7" title="3.5점"></label>
			...
			<input type="text" name="contents" class="star_box"
				...
				name="MEM_ID" VALUE="Ef-8R3fBQ9V7oNLNfOv7gHjUqXb9k7pn6QkITa77XvE">
			<input type="submit" class="btn02" value="리뷰 등록"> >>>>>>>
			branch 'main' of
			https://github.com/2023-SMHRD-KDT-AI-16/PLAY_SCENT.git
