                     ...
                     <swiper-slide>
                         <li><a href="PerfumeDetail.jsp?pfIdx=<%= womanperfume.get(rd).getPF_IDX()%>">
                              ...
                              <div class="product_price">
                                 <div class="ohjinhee_point"><%
                                        //금액 .찍어서 여기서 변수 저장
                                          int price = (int)Math.round(womanperfume.get(rd).getPF_PRICE() / 3);//double -> 정수형으로
                                          String money = df.format(price); // .찍어줌 %>
                                        <h3 class="per_price"><%= money %>원<span></span></h3>
                                      </div>
                                 <!-- <h2 class="sale">42%</h2> -->
                     ...
                     <swiper-slide>
                         <li><a href="PerfumeDetail.jsp?pfIdx=<%= manperfume.get(rd).getPF_IDX()%>">
                              ...
                              <div class="product_price">
                                 <div class="ohjinhee_point"><%
                                        //금액 .찍어서 여기서 변수 저장
                                          int price = (int)Math.round(manperfume.get(rd).getPF_PRICE() / 3);//double -> 정수형으로
                                          String money = df.format(price); // .찍어줌 %>
                                        <h3 class="per_price"><%= money %>원<span></span></h3>
                                      </div>
                                 <!-- <h2 class="sale">42%</h2> -->
	                  ...
	                  <swiper-slide>
	                      <li><a href="PerfumeDetail.jsp?pfIdx=<%= summerperfume.get(i).getPF_IDX()%>">
	                           ...
	                           <div class="product_price">
	                               <div class="ohjinhee_point"><%
                                      //금액 .찍어서 여기서 변수 저장
                                        int price = (int)Math.round(summerperfume.get(i).getPF_PRICE() / 3);//double -> 정수형으로
                                        String money = df.format(price); // .찍어줌 %>
                                      <h3 class="per_price"><%= money %>원<span></span></h3>
                                    </div>
	                       </a></li>
